...
- 최근 작업(PRD `iocp-game-server-engine.prd.md`)에서 IOCP 축은 **Session Idle Timeout**, **Admin ServerStatus**, **RIO 코드 분리**, **Release 서비스 모드 1000세션 기준선** 까지 완료됨.
...
- 기존 벤치 결과 파일은 workload 기준이 달라 **폐기**하고, `benchmark-results-05-iocp-release-1000-sessions.md`를 새 기준선으로 사용한다.
...
- 현재 벤치 기준선: `docs/benchmark-results-05-iocp-release-1000-sessions.md`
